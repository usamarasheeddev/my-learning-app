...
export default function Sidebar() {
  return (
    <div>
      ...
      <div class="bg-gray-light w-16 h-screen">
...
<div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900 rounded ">
  ...
  <a class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-blue hover:text-white" href="#">
    ...
    <a class="flex items-center justify-center w-12 h-12 mt-2   rounded" href="#">
      <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
